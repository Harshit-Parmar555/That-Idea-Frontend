...
const UserDetail = ({ user }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-10 mt-28">
      <div className="w-full sm:w-[90%] lg:w-[55%] flex flex-col items-center sm:flex-row  justify-between text-center sm:text-left gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-[Inter] text-xs text-zinc-200">{user?.email}</p>
          </div>
        </div>
